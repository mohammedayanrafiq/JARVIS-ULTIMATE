...
path = r"c:\Users\Admin\OneDrive\Desktop\jarvis-desktop\src\index.html"
...
<div id="tauri-safety-modal" style="display:none;position:fixed;inset:0;z-index:999998;background:rgba(0,0,0,0.8);flex-direction:column;align-items:center;justify-content:center;">
    <div style="background:#1e1e28;border:1px solid #c8a97e;padding:30px;border-radius:12px;max-width:500px;text-align:center;">
        <h2 style="color:#c8a97e;margin-bottom:15px;font-family:'Instrument Serif', serif;font-size:32px;">?? Destructive Action Requested</h2>
...
"""
html = html.replace("</body>", tauri_script + "\n</body>")

# 4. Modify chatWithJarvis
target = r"chatHistory.push({ role: 'assistant', content: reply });"
replacement = """chatHistory.push({ role: 'assistant', content: reply });
